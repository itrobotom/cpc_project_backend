...
const NewsSchema = new mongoose.Schema(
    {
        ...
        //ЭТО БУДЕТ НЕ ТЕГИ, А НАПРАВЛЕНИЕ
        // tags: {
        //     type: Array,
        ...
        // },
        //ДОБАВИТЬ ДАТУ
        //ДОБАВИТЬ ПОЛЕ НА ССЫЛКУ ОРИГИНАЛА СТАТЬИ
        //ДОБАВИТЬ ПОЛЕ ДЛЯ ССЫЛКИ НА ОБРАЗОВАТЕЛЬНУЮ ПРОГРАММУ, ДОЛЖНО ВЫВЕСТИСЬ:
        //Образовательная программа: Мехатроника и робототехника (гиперссылкой)
        imageUrl: String,
    },
);
